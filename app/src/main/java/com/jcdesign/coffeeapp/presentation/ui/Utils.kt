package com.jcdesign.coffeeapp.presentation.ui
...
import com.jcdesign.coffeeapp.presentation.ui.auth.LoginFragment
import com.jcdesign.coffeeapp.presentation.ui.auth.RegisterFragment
    ...
    when {
        ...
        failure.errorCode == 406 -> {
            if (this is RegisterFragment) {
                requireView().snackbar("Not Acceptable")
            } else {
                (this as BaseFragment<*, *, *>).logout()
            }
        }
